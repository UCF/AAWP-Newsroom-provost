        ...
        <div class="row d-flex justify-content-center">
            ...
            <?php if ( has_post_thumbnail() ): ?>
              ...
              <div class="post-thumbnail ">
                <div class="pn-article-image"><img src="<?php echo esc_url( $thumb ); ?>" class="img-fluid rounded  mx-auto d-block" alt="<?php echo esc_attr( $alt ); ?>"/></div>
           ...
           <?php    
              foreach( $termMerge as $term ) {
                $term_link = get_term_link( $term ); ?>
                  ...
                  <a href="<?php echo esc_url( $term_link ) ?>" class="term-link btn btn-secondary btn-sm my-1 mr-2"><?php echo $term->name ?></a>
      ...
      <?php if ($categories): ?>
        ...
        <?php $my_query = new WP_Query($args); ?>
          <?php if( $my_query->have_posts() ) : ?>
           ...
           <h2 class="heading-underline">You Might Also Like</h2>

          <div class="row">
            <?php while ($my_query->have_posts()) : $my_query->the_post(); ?>
              <div class="col-md-4">

                <a href="<?php the_permalink()?>" class="related-thumb"><?php the_post_thumbnail( 'full', array( 'class'  => 'img-fluid mb-3 rounded' ) ); ?></a>
