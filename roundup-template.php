	...
	<div class="container mt-4 mt-sm-5 mb-5 pb-sm-4">
	    ...
	    <section class="roundup-header mb-md-5">
	        ...
	        <div class="row  d-flex h-100">
	            <div class="col-12 col-md-2 text-center offset-md-1">
	                <div class="twitter-icon"><img
	                        src="https://provost.ucf.edu/news/wp-content/uploads/sites/3/2020/03/UCF-Academics-Avatar-150x150.png"
	                        class="img-fluid"></div>
	                <div class="twitter-handle"><i class="fa fa-twitter" aria-hidden="true"></i><a
	                        href="https://twitter.com/UCFAcademics" class="text-default-aw">ucfacademics</a></div>
	            </div>
	            <div class="col-12 col-md-8 h-100 text-center text-md-left pt-3 pt-md-0 align-self-center">
	                ...
	                <p class="has-text-align-left lead text-default-aw">UCF has a long history of <a
	                        href="https://digitallearning.ucf.edu/">pioneering excellence and innovation</a> in digital
	                    learning.</p>
	            </div>
	        </div>
	    </section>
	                ...
	                <div class="links-article px-md-1 h-100">
	                    ...
	                    <div class="links-article-info h-100">
	                        ...
	                        <a href="<?php echo esc_url( get_permalink($postID)); ?>">
	                            ...
	                            <h2 class="h6 text-secondary links-header px-md-4"><?php echo get_the_title($postID); ?>
	                            </h2>
	                        </a>
	    ...
	    <?php
           if($postContent):
             ...
             ?>
	    <div class="text-center"><a href="<?php esc_attr(bloginfo('url')); ?>"
	            class="text-uppercase btn btn-outline-secondary btn-sm"><?php bloginfo('name') ?></a></div>
	</div>
	<?php get_footer(); ?>